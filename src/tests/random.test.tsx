...
describe("Random Component", () => {
  ...
  it("renders correctly", async () => {
    ...
    await fireEvent.click(await screen.findByTestId("load-all-button"));
...
describe("Random Component", () => {
  ...
  it("renders correctly", async () => {
    renderWithProviders(<Random />);
    await fireEvent.click(await screen.findByTestId("load-next-user"));
    const listItems = await screen.findAllByRole("listitem");
    expect(listItems).toHaveLength(1);
    screen.debug(await screen.findByTestId("users-container"));
  });
});
